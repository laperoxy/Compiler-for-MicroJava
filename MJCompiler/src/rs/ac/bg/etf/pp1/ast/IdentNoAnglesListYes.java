...
public class IdentNoAnglesListYes extends IdentAnglesList {

    private String varName;
    private IdentAnglesList IdentAnglesList;

    public IdentNoAnglesListYes (String varName, IdentAnglesList IdentAnglesList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IdentNoAnglesListYes(\n");
