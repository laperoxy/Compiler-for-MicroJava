...
public class VarDeclNoAngles extends VarDecl {

    private Type Type;
    private String varName;
    private IdentAnglesList IdentAnglesList;

    public VarDeclNoAngles (Type Type, String varName, IdentAnglesList IdentAnglesList) {
        this.Type=Type;
